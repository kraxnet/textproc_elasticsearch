...
SUB_LIST+=      JAVA_HOME=${JAVA_HOME} ELASTICSEARCH_CONFDIR=${ELASTICSEARCH_CONFDIR} ELASTICSEARCH_LOGDIR=${ELASTICSEARCH_LOGDIR} ELASTICSEARCH_DATADIR=${ELASTICSEARCH_DATADIR} ELASTICSEARCH_WORKDIR=${ELASTICSEARCH_WORKDIR} ELASTICSEARCH_USER=${ELASTICSEARCH_USER} ELASTICSEARCH_GROUP=${ELASTICSEARCH_GROUP}
